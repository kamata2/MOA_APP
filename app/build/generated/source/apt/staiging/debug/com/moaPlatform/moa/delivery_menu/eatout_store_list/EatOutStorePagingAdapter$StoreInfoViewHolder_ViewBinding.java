...
public class EatOutStorePagingAdapter$StoreInfoViewHolder_ViewBinding implements Unbinder {
  private EatOutStorePagingAdapter.StoreInfoViewHolder target;

  @UiThread
  public EatOutStorePagingAdapter$StoreInfoViewHolder_ViewBinding(
      EatOutStorePagingAdapter.StoreInfoViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    EatOutStorePagingAdapter.StoreInfoViewHolder target = this.target;
