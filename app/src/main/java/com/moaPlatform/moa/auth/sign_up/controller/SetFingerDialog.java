...
public class SetFingerDialog extends Dialog {
...
//        getWindow().setAttributes(layoutParams);
        ...
        setContentView(R.layout.finger_appset_dialog);
    ...
    //생성자 생성
    public SetFingerDialog(@NonNull Context context, View.OnClickListener positiveListener) {
        super(context);
