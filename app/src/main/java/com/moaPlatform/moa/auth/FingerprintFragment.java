 ...
 */
public class FingerprintFragment extends DialogFragment implements FingerprintUiCallback {

    private FingerprintUiHelper fingerprintUiHelper;
    private LogInFingerActivity activity;
    ...
    public void onAttach(Context context) {
        ...
        activity = (LogInFingerActivity) getActivity();
    }
...
//        getDialog().setTitle(title);
        ...
        cancelBtn = v.findViewById(R.id.cancel_finger);

        closeButton = v.findViewById(R.id.rlCloseContainer);
